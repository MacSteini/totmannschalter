...
function render_main_config(array $main, array $flash): void
{
    ...
    $rateLimitDefaultDir = $rateLimitDefaultDir !== '' ? $rateLimitDefaultDir . '/ratelimit' : '{state_dir}/ratelimit';
