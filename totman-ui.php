...
.mobile-status-details{display:none}.mobile-toggle-closed,.mobile-toggle-open{display:none}.when-open{display:none}details[open] .when-closed{display:none}details[open] .when-open{display:inline}.desktop-disclosure-label{display:inline}.status-details{display:block;margin-bottom:var(--space-m);background:var(--bg-card);border:1px solid var(--border);border-radius:var(--radius-m);box-shadow:0 1px 3px rgba(0,0,0,.1);overflow:hidden}.status-summary{list-style:none;cursor:pointer;display:grid;gap:.55rem;margin:.75rem;padding:.85rem 3rem .85rem 1rem;border:1.5px solid var(--border);border-radius:var(--radius-m);background:var(--bg-main);position:relative}.status-summary::-webkit-details-marker{display:none}.status-summary:after{content:"";position:absolute;right:1rem;top:1.05rem;width:.65rem;height:.65rem;border-right:2px solid var(--text-muted);border-bottom:2px solid var(--text-muted);transform:rotate(45deg);transition:transform .16s ease,top .16s ease}.status-details[open] .status-summary:after{transform:rotate(225deg);top:1.35rem}.mobile-status-title{font-weight:900;color:var(--text-primary)}.mobile-status-line{display:flex;flex-wrap:wrap;gap:.18rem .55rem;color:var(--text-muted);font-size:.84rem;font-weight:700}.mobile-status-line span{display:inline;padding:0;border:0;border-radius:0;background:transparent}.status-details[data-status-has-issues="1"] .mobile-status-title{color:var(--warning)}.status-grid{padding:0 1rem 1rem;margin:0}.mobile-toggle-closed{display:inline}.preflight-card[open] .mobile-toggle-closed{display:none}.preflight-card[open] .mobile-toggle-open{display:inline}.preflight-card{margin-bottom:var(--space-m)}@media(max-width:700px){.desktop-disclosure-label{display:none}.status-summary{align-items:start}.status-grid{grid-template-columns:1fr;gap:.55rem}.status-grid .stat-card{min-height:auto;padding:.75rem;gap:.75rem}.status-grid .stat-icon{width:42px;height:42px}.status-grid .stat-value{font-size:1rem}.status-grid .stat-desc{font-size:.8rem}.preflight-summary{display:grid;align-items:start;gap:.55rem;margin:.75rem;padding:.85rem 3rem .85rem 1rem;border:1.5px solid var(--border);border-radius:var(--radius-m);background:var(--bg-main);position:relative}.preflight-heading{gap:.35rem}.preflight-next{font-size:.86rem}.preflight-counts{justify-self:start}.preflight-grid{padding:0 1rem 1rem;grid-template-columns:1fr}}
nav[role=tablist]{padding:.35rem;background:color-mix(in srgb,var(--bg-surface),var(--bg-main)26%);border:1px solid var(--border);border-radius:999px;box-shadow:0 10px 28px rgba(15,23,42,.06);gap:.35rem;margin-bottom:.65rem}.nav-item{min-width:0!important;flex:1 1 8rem!important;border-radius:999px!important;padding:.85rem 1.1rem!important;font-size:1.12rem!important;font-weight:850!important}.nav-item:not(.active):hover,.sub-nav-item:not(.active):hover{background:color-mix(in srgb,var(--accent-glow),transparent 35%);color:var(--text-primary)}.sub-nav{display:flex;flex-wrap:wrap;gap:.3rem;padding:.3rem;background:color-mix(in srgb,var(--bg-surface),var(--bg-main)38%);border:1px solid var(--border);border-radius:999px;margin-top:-.15rem;margin-bottom:var(--space-l);box-shadow:0 6px 18px rgba(15,23,42,.045)}.sub-nav-item{flex:1 1 6.5rem!important;border-radius:999px!important;padding:.58rem .85rem!important;font-size:.94rem!important;font-weight:760!important}.sub-nav-item.active{background:var(--bg-card);color:var(--accent);box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--accent),transparent 72%),0 5px 14px rgba(15,23,42,.06)}.sub-nav-item.active:after{display:none}.site-footer{border-top:0;margin-top:3rem;padding-block:clamp(1rem,2.4vw,1.5rem)clamp(1.4rem,3vw,2rem)}.footer-nav{display:flex;flex-wrap:wrap;justify-content:center;gap:.35rem;width:fit-content;max-width:100%;margin-inline:auto;padding:.45rem;background:color-mix(in srgb,var(--bg-surface),var(--bg-main)30%);border:1px solid var(--border);border-radius:999px}.footer-nav>a{justify-self:auto!important;padding:.38rem .65rem;border-radius:999px}.footer-nav>a:hover,.footer-nav>a:focus-visible{background:var(--accent-glow);color:var(--accent)}@media(max-width:700px){nav[role=tablist],.sub-nav{border-radius:26px;padding:.35rem;gap:.35rem}.nav-item{flex:1 1 7.5rem!important;border-radius:999px!important;padding:.78rem .85rem!important}.sub-nav-item{flex:1 1 5.8rem!important;border-radius:999px!important}.footer-nav{border-radius:24px;width:100%}}.file-registry-note{border:1px solid color-mix(in srgb,var(--border),var(--warning) 34%);border-left:4px solid color-mix(in srgb,var(--warning),transparent 18%);background:color-mix(in srgb,var(--bg-surface),var(--warning) 12%);color:var(--text-primary);font-size:.95rem;font-weight:400;line-height:1.55}.file-registry-note a{color:color-mix(in srgb,var(--accent),var(--text-primary) 32%);font-weight:600;text-decoration-thickness:.08em;text-underline-offset:.16em}.file-registry-note a:hover,.file-registry-note a:focus-visible{color:color-mix(in srgb,var(--accent),var(--text-primary) 18%)}.file-registry-note code{font-weight:500;background:color-mix(in srgb,var(--bg-surface),var(--warning) 16%);border:1px solid color-mix(in srgb,var(--border),var(--warning) 26%);border-radius:6px;padding:.08rem .28rem}.card>h2+.notice.file-registry-note,.card>h3+.notice.file-registry-note,.card>.card-header+.notice.file-registry-note{margin-top:calc(var(--space-l) + .35rem)}.file-registry-note+fieldset,.file-registry-note+.form-grid,.file-registry-note+.file-registry-grid{margin-top:calc(var(--space-l) + .1rem)}
CSS;
}
function js(): string
{
...
if (statusDetails) {
const savedStatusDetails = localStorage.getItem('totman_status_details_open') ?? localStorage.getItem('totman_mobile_status_open');
statusDetails.open = savedStatusDetails === '1';
statusDetails.addEventListener('toggle', () => {
localStorage.setItem('totman_status_details_open', statusDetails.open ? '1' : '0');
});
}
