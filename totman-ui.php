...
function render_recipients(array $recips, array $flash, string $downloadBaseDir = '/var/lib/totman/files'): void
{
    ...
    echo'</div></div><div id="recipients-files" class="sub-view hidden" role="tabpanel"><div class="card"><div class="card-header"><h3>' . h(t('File Alias Registry')) . '</h3><div class="header-actions"><button type="button" class="btn-primary add-row" data-template="file-template" data-target="file-registry-body" data-insert="prepend" data-focus="input[name=&quot;file_alias[]&quot;]">' . h(t('Add Alias')) . '</button></div></div><div class="notice file-registry-note"><strong>' . h(t('Download directory:')) . '</strong> <code>' . h($downloadBaseDir) . '</code><br>' . h(t('Place files there via SFTP, terminal, hosting file manager, or Docker volume before referencing them here.')) . '<br>' . h(t('Alias paths are relative to that directory. Example: shared/letter.pdf.')) . '</div><div id="file-delete-bin"></div><div id="file-registry-body" class="file-registry-grid">';
