...
1. Apply the test preset in the effective main config and set `to_self` plus all recipient addresses in the configured recipient file to your own addresses.
