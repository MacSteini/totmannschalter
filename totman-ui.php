...
function render_recipients(array $recips, array $flash, string $downloadBaseDir = '/var/lib/totman/files'): void
{
    ...
    echo'</div></div><div id="recipients-files" class="sub-view hidden" role="tabpanel"><div class="card"><div class="card-header"><h3>' . h(t('File Alias Registry')) . '</h3></div><div class="notice file-registry-note spaced-notice"><strong>' . h(t('Download directory:')) . '</strong> <code>' . h($downloadBaseDir) . '</code><br>' . h(t('Place files there via SFTP, terminal, hosting file manager, or Docker volume. The UI lists safe files found there and lets you assign aliases.')) . '<br>' . h(t('Paths are shown for orientation only and are not edited in the Web UI.')) . '</div><div id="file-delete-bin"></div><div id="file-registry-body" class="file-registry-grid">';
